...
class ModelAccountCustomer extends Model
{
    ...
    {
        $this->db->query("UPDATE " . DB_PREFIX . "customer SET email = '" . $this->db->escape($email) . "'  WHERE customer_id = '" . $this->db->escape($customer_id) . "'");
    }
    ...
    public function editImage($customer_id, $image)
    {
    ...
    public function getCustomerPassword($customer_id)
    {
    ...
    public function getCustomerCustomFields($customer_id)
    {
        $customer = $this->getCustomer($customer_id);
        $fields = [];
        if (!empty($customer)) {
            $fields = (array)json_decode($customer['custom_field']);
        }
        return $fields;
    }
