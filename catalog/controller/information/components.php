<?php
class ControllerInformationComponents extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('information/components');
...
//		$data['content_bottom'] = $this->load->controller('common/content_bottom');
		...
		$this->response->setOutput($this->load->view('information/components', $data));
	}
