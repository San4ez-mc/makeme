...
//		$this->document->setTitle($this->language->get('text_address_add'));
        $this->document->setRobots('noindex,follow');
...
//				$format = '{company}' . "\n" . '{address_1}' . "\n" . '{address_2}' . "\n" . '{city} {postcode}' . "\n" . '{zone}' . "\n" . '{country}';
            ...
            $replace = array(
                ...
                'zone' => !empty($result['zone']) ? $result['zone'] : $result['address_1'] . ',' . $result['custom_field'][2] . ',' . $result['custom_field'][3],
...
//		$data['content_bottom'] = $this->load->controller('common/content_bottom');
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['custom_field']['address'][1])) {
            $data['phone'] = $this->request->post['custom_field'][1];
        } elseif (isset($address_info['custom_field'][1])) {
            $data['phone'] = $address_info['custom_field'][1];
        } else {
            $data['phone'] = '';
        }

        if (isset($this->request->post['custom_field']['address'][2])) {
            $data['house'] = $this->request->post['custom_field'][2];
        } elseif (isset($address_info['custom_field'][2])) {
            $data['house'] = $address_info['custom_field'][2];
        } else {
            $data['house'] = '';
        }

        if (isset($this->request->post['custom_field']['address'][3])) {
            $data['apartment'] = $this->request->post['custom_field'][3];
        } elseif (isset($address_info['custom_field'][3])) {
            $data['apartment'] = $address_info['custom_field'][3];
        } else {
            $data['apartment'] = '';
        }
        ...
        $data['title'] = $this->language->get('text_address_add');
