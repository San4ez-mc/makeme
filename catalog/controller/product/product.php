...
//			$this->document->addStyle('catalog/view/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css');
            ...
            if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
                ...
                $data['price_'] = (int)$this->tax->calculate($product_info['price'], $product_info['tax_class_id'], $this->config->get('config_tax'));
                $data['currency'] = substr($data['price'], -3);
            } else {
                $data['price'] = false;
            }
            ...
            $components = $this->model_catalog_component->getComponents([
            ...
            foreach ($components as $component) {
                ...
                if ($component['image']) {
                    $image = $this->model_tool_image->resize($component['image'], 120, 120);
                } else {
                ...
                $data['components'][] = array(
                    ...
                    'thumb' => $image,
                    'name' => $component['name'],
                    'description' => utf8_substr(trim(strip_tags(html_entity_decode($component['description'], ENT_QUOTES, 'UTF-8'))), 0, $this->config->get('theme_' . $this->config->get('config_theme') . '_product_description_length')) . '..',
                    'price' => $price,
                );
            }
