...
//            );
            ...
            $data['sorts'][] = array(
                ...
                'value' => 'p.date-ASC',
                'href' => $this->url->link('product/catalog', 'path=' . $this->request->get['path'] . '&sort=p.date&order=ASC' . $url)
            );

            $data['sorts'][] = array(
                'text' => $this->language->get('text_rating_asc'),
                'value' => 'rating-ASC',
                'href' => $this->url->link('product/catalog', 'path=' . $this->request->get['path'] . '&sort=rating&order=ASC' . $url)
            );
