...
class ControllerExtensionModuleNewsletter extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/javascript/jquery/jquery-2.1.1.min.js', 'header');
		$this->document->addScript('catalog/view/javascript/jquery/jquery.cookie.js', 'header');
