...
class ControllerCommonColumnLeft extends Controller
{
    public function index()
    {
        if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/component')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_component'),
                    'href' => $this->url->link('catalog/component', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/component_category')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_component_category'),
                    'href' => $this->url->link('catalog/component_category', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'catalog/boxing')) {
                $catalog[] = array(
                    'name' => $this->language->get('text_boxing'),
                    'href' => $this->url->link('catalog/boxing', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'marketing/promo')) {
                $marketing[] = array(
                    'name' => $this->language->get('text_promos'),
                    'href' => $this->url->link('marketing/promo', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
