...
class ControllerCatalogCategory extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['boxing_id'])) {
            $data['boxing_id'] = $this->request->post['boxing_id'];
        } elseif (!empty($category_info)) {
            $boxing = $this->model_catalog_category->getCategoryBoxing($category_info['category_id']);
