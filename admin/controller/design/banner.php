...
class ControllerDesignBanner extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->post['template_id'])) {
            ...
            $data['template_id'] = $banner_info['template_id'];
        } else {
            $data['template_id'] = 1;
        }
        ...
        $data['templates'] = [
            ...
            [
                'id' => 1,
                'name' => 'Верхний баннер на главной'
            ],
            [
                'id' => 2,
                'name' => 'Этапы создания'
        ...
        if (isset($this->request->post['banner_image'])) {
            foreach ($this->request->post['banner_image'] as $language_id => $value) {
                foreach ($value as $banner_image_id => $banner_image) {
                    if ((utf8_strlen($banner_image['title']) < 2) || (utf8_strlen($banner_image['title']) > 100)) {
