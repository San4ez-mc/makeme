...
class ModelExtensionModuleSocnetauth2 extends Model 
{
	...
	public function makeCode($data)
	{
        ...
        $template_data['socnetauth2_format'] = 'makeme';

        $data['socnetauth2_reg_code_makeme'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_reg', $template_data);
        $data['socnetauth2_simplereg_code_makeme'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simplereg', $template_data);
        $data['socnetauth2_simple_code_makeme'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_simple', $template_data);
        $data['socnetauth2_account_code_makeme'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_account', $template_data);
        $data['socnetauth2_checkout_code_makeme'] = $this->load->view('extension/module/socnetauth2_blocks/socnetauth2_checkout', $template_data);
