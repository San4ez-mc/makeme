...
// Heading
$_['heading_title']          = 'Компоненты';

// Text
$_['text_success']           = 'Настройки успешно изменены!';
$_['text_list']              = 'Список компонентов';
$_['text_add']               = 'Добавить';
...
// Entry
$_['entry_name']             = 'Название компонента';
...
$_['entry_related']          = 'Рекомендуемые компоненты';
$_['entry_related_article']  = 'Рекомендуем почитать';
$_['entry_tag']          	 = 'Теги компонента';
...
$_['help_upc']               = 'Универсальный Код компонента';
$_['help_ean']               = 'Европейский Код компонента';
$_['help_jan']               = 'Японский Код компонента';
$_['help_isbn']              = 'Международный стандартный книжный номер';
$_['help_mpn']               = 'Код Партии компонента Производителя';
$_['help_manufacturer']      = '(Автозаполнение)';
$_['help_minimum']           = 'Минимальное количество заказа этого компонента';
$_['help_stock_status']      = 'Статус, показываемый, когда компонента нет на складе (количество = 0)';
$_['help_points']            = 'Количество баллов для покупки компонента. Поставьте 0, чтобы не использовать баллы.';
...
$_['error_model']            = 'Код компонента компонента должна содержать от 3 до 64 символов!';
